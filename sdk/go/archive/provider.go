...
func NewProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumi:providers:archive", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:archive/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
