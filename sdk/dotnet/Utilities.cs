...
namespace Pulumi.Archive
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Archive.version.txt");
    ...
    internal sealed class ArchiveResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ArchiveResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
