...
pulumi.runtime.registerResourceModule("archive", "index/file", _module)
pulumi.runtime.registerResourcePackage("archive", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:archive") {
