...
class GetFileResult:
    ...
    def exclude_symlink_directories(self) -> Optional[_builtins.bool]:
        """
    ...
    def output_base64sha512(self) -> _builtins.str:
        """
    ...
    def output_file_mode(self) -> Optional[_builtins.str]:
        """
    ...
    def output_md5(self) -> _builtins.str:
        """
        MD5 of output file
        """
    ...
    def output_sha(self) -> _builtins.str:
        """
    ...
    def output_sha512(self) -> _builtins.str:
        """
    ...
    def output_size(self) -> _builtins.int:
        """
    ...
    def source_content(self) -> Optional[_builtins.str]:
        """
    ...
    def source_content_filename(self) -> Optional[_builtins.str]:
        """
    ...
    def source_file(self) -> Optional[_builtins.str]:
        """
...
def get_file(exclude_symlink_directories: Optional[_builtins.bool] = None,
             excludes: Optional[Sequence[_builtins.str]] = None,
             output_file_mode: Optional[_builtins.str] = None,
             output_path: Optional[_builtins.str] = None,
             source_content: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool exclude_symlink_directories: Boolean flag indicating whether symbolically linked directories should be excluded during the creation of the archive. Defaults to `false`.
    :param Sequence[_builtins.str] excludes: Specify files/directories to ignore when reading the `source_dir`. Supports glob file matching patterns including doublestar/globstar (`**`) patterns.
    :param _builtins.str output_file_mode: String that specifies the octal file mode for all archived files. For example: `"0666"`. Setting this will ensure that cross platform usage of this module will not vary the modes of archived files (and ultimately checksums) resulting in more deterministic behavior.
    :param _builtins.str output_path: The output of the archive file.
    :param _builtins.str source_content: Add only this content to the archive with `source_content_filename` as the filename. One and only one of `source`, `source_content_filename` (with `source_content`), `source_file`, or `source_dir` must be specified.
...
def get_file_output(exclude_symlink_directories: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                    excludes: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                    output_file_mode: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                    output_path: Optional[pulumi.Input[_builtins.str]] = None,
                    source_content: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                    source_content_filename: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                    source_dir: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                    source_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
